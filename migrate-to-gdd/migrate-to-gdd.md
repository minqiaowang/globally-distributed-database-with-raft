# Migrate Application to Globally Distributed Database

## Introduction

When you want to migrate the application from the non-shard database to the globally distributed database, you need re-design the schema, migrate the data and modify the application.
...
- Migrate data to the globally distributed database.
...
- Deploy the Globally Distributed Database.
